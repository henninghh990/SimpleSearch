 ...
 */
/**
 * Norwegian Default Topic for SimpleSearch
 *
 * @package simplesearch
 * @subpackage lexicon
 * @language no
 */
$_lang['sisea.no_results'] = 'Det var ingen resultater for søket: "[[+query]]".';
$_lang['sisea.search'] = 'Søk';
$_lang['sisea.results_found'] = '[[+count]] resultater funnet for "[[+text]]"';
$_lang['sisea.result_pages'] = 'Resultatsider:';
$_lang['sisea.index_finished'] = 'Indeksert [[+total]] ressurser.';
